...
func (c *FakeImages) Apply(ctx context.Context, image *apiv1alpha1.ImageApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Image, err error) {
	if image == nil {
	...
	emptyResult := &v1alpha1.Image{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(imagesResource, c.ns, *name, types.ApplyPatchType, data, opts.ToPatchOptions()), emptyResult)
...
func (c *FakeImages) ApplyStatus(ctx context.Context, image *apiv1alpha1.ImageApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Image, err error) {
	if image == nil {
		return nil, fmt.Errorf("image provided to Apply must not be nil")
	}
	data, err := json.Marshal(image)
	...
	emptyResult := &v1alpha1.Image{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(imagesResource, c.ns, *name, types.ApplyPatchType, data, opts.ToPatchOptions(), "status"), emptyResult)
