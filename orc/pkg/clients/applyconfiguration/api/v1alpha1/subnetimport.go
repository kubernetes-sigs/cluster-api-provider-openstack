...
// SubnetImportApplyConfiguration represents a declarative configuration of the SubnetImport type for use
// with apply.
...
// SubnetImportApplyConfiguration constructs a declarative configuration of the SubnetImport type for use with
// apply.
func SubnetImport() *SubnetImportApplyConfiguration {
	return &SubnetImportApplyConfiguration{}
}
