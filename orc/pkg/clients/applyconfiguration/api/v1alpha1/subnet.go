...
func extractSubnet(subnet *apiv1alpha1.Subnet, fieldManager string, subresource string) (*SubnetApplyConfiguration, error) {
	b := &SubnetApplyConfiguration{}
	err := managedfields.ExtractInto(subnet, internal.Parser().Type("com.github.k-orc.openstack-resource-controller.api.v1alpha1.Subnet"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
