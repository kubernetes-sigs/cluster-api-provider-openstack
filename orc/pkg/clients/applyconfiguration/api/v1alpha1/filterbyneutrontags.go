...
type FilterByNeutronTagsApplyConfiguration struct {
	...
	TagsAny    []v1alpha1.NeutronTag `json:"tagsAny,omitempty"`
	NotTags    []v1alpha1.NeutronTag `json:"notTags,omitempty"`
	NotTagsAny []v1alpha1.NeutronTag `json:"notTagsAny,omitempty"`
}
...
func (b *FilterByNeutronTagsApplyConfiguration) WithTags(values ...v1alpha1.NeutronTag) *FilterByNeutronTagsApplyConfiguration {
	for i := range values {
...
func (b *FilterByNeutronTagsApplyConfiguration) WithTagsAny(values ...v1alpha1.NeutronTag) *FilterByNeutronTagsApplyConfiguration {
	for i := range values {
...
func (b *FilterByNeutronTagsApplyConfiguration) WithNotTags(values ...v1alpha1.NeutronTag) *FilterByNeutronTagsApplyConfiguration {
	for i := range values {
...
func (b *FilterByNeutronTagsApplyConfiguration) WithNotTagsAny(values ...v1alpha1.NeutronTag) *FilterByNeutronTagsApplyConfiguration {
	for i := range values {
