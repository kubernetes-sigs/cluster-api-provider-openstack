		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"filter": {
						SchemaProps: spec.SchemaProps{
							Description: "Filter contains an resource query which is expected to return a single result. The controller will continue to retry if filter returns no results. If filter returns multiple results the controller will set an error state and will not continue to retry.",
...
func schema_k_orc_openstack_resource_controller_api_v1alpha1_ImageSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ImageSpec defines the desired state of a ORC object.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"import": {
						SchemaProps: spec.SchemaProps{
							Description: "Import refers to an existing ORC object which will be imported instead of creating a new resource.",
