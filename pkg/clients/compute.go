...
type ComputeClient interface {
	...
	CreateServerGroup(name string, policy string) (*servergroups.ServerGroup, error)
...
func (c computeClient) CreateServerGroup(name string, policy string) (*servergroups.ServerGroup, error) {
...
func (e computeErrorClient) CreateServerGroup(_ string, _ string) (*servergroups.ServerGroup, error) {
	return nil, e.error
}
