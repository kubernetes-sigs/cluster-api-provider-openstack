...
import (
	...
	v1alpha6 "sigs.k8s.io/cluster-api-provider-openstack/pkg/generated/informers/externalversions/api/v1alpha6"
...
type Interface interface {
	...
	// V1alpha6 provides access to shared informers for resources in V1alpha6.
	V1alpha6() v1alpha6.Interface
...
// V1alpha6 returns a new v1alpha6.Interface.
func (g *group) V1alpha6() v1alpha6.Interface {
	return v1alpha6.New(g.factory, g.namespace, g.tweakListOptions)
}
