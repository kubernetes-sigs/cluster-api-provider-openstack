...
type OpenStackMachineTemplateInformer interface {
	...
	Lister() v1alpha6.OpenStackMachineTemplateLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.InfrastructureV1alpha6().OpenStackMachineTemplates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InfrastructureV1alpha6().OpenStackMachineTemplates(namespace).Watch(context.TODO(), options)
			},
		},
		&apiv1alpha6.OpenStackMachineTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *openStackMachineTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiv1alpha6.OpenStackMachineTemplate{}, f.defaultInformer)
}

func (f *openStackMachineTemplateInformer) Lister() v1alpha6.OpenStackMachineTemplateLister {
	return v1alpha6.NewOpenStackMachineTemplateLister(f.Informer().GetIndexer())
}
