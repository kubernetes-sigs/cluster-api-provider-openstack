...
// OpenStackServerApplyConfiguration represents an declarative configuration of the OpenStackServer type for use
// with apply.
...
// OpenStackServer constructs an declarative configuration of the OpenStackServer type for use with
// apply.
func OpenStackServer(name, namespace string) *OpenStackServerApplyConfiguration {
	b := &OpenStackServerApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("OpenStackServer")
...
func extractOpenStackServer(openStackServer *apiv1alpha1.OpenStackServer, fieldManager string, subresource string) (*OpenStackServerApplyConfiguration, error) {
	...
	b.WithName(openStackServer.Name)
	b.WithNamespace(openStackServer.Namespace)
...
func (b *OpenStackServerApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
