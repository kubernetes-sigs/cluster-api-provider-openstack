...
func extractOpenStackClusterTemplate(openStackClusterTemplate *apiv1beta1.OpenStackClusterTemplate, fieldManager string, subresource string) (*OpenStackClusterTemplateApplyConfiguration, error) {
	b := &OpenStackClusterTemplateApplyConfiguration{}
