...
func OpenStackClusterTemplate(name, namespace string) *OpenStackClusterTemplateApplyConfiguration {
	...
	b.WithKind("OpenStackClusterTemplate")
...
func ExtractOpenStackClusterTemplateFrom(openStackClusterTemplate *apiv1beta1.OpenStackClusterTemplate, fieldManager string, subresource string) (*OpenStackClusterTemplateApplyConfiguration, error) {
	b := &OpenStackClusterTemplateApplyConfiguration{}
	err := managedfields.ExtractInto(openStackClusterTemplate, internal.Parser().Type("io.k8s.sigs.cluster-api-provider-openstack.api.v1beta1.OpenStackClusterTemplate"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(openStackClusterTemplate.Name)
	b.WithNamespace(openStackClusterTemplate.Namespace)
...
func (b *OpenStackClusterTemplateApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *OpenStackClusterTemplateApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *OpenStackClusterTemplateApplyConfiguration) GetAPIVersion() *string {
...
func (b *OpenStackClusterTemplateApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
