...
func extractOpenStackMachine(openStackMachine *apiv1alpha6.OpenStackMachine, fieldManager string, subresource string) (*OpenStackMachineApplyConfiguration, error) {
	b := &OpenStackMachineApplyConfiguration{}
	err := managedfields.ExtractInto(openStackMachine, internal.Parser().Type("io.k8s.sigs.cluster-api-provider-openstack.api.v1alpha6.OpenStackMachine"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
