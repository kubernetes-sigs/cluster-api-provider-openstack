...
func extractOpenStackMachineTemplate(openStackMachineTemplate *apiv1alpha6.OpenStackMachineTemplate, fieldManager string, subresource string) (*OpenStackMachineTemplateApplyConfiguration, error) {
	b := &OpenStackMachineTemplateApplyConfiguration{}
	err := managedfields.ExtractInto(openStackMachineTemplate, internal.Parser().Type("io.k8s.sigs.cluster-api-provider-openstack.api.v1alpha6.OpenStackMachineTemplate"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
