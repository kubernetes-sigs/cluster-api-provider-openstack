...
func extractOpenStackClusterTemplate(openStackClusterTemplate *apiv1alpha7.OpenStackClusterTemplate, fieldManager string, subresource string) (*OpenStackClusterTemplateApplyConfiguration, error) {
	b := &OpenStackClusterTemplateApplyConfiguration{}
	err := managedfields.ExtractInto(openStackClusterTemplate, internal.Parser().Type("io.k8s.sigs.cluster-api-provider-openstack.api.v1alpha7.OpenStackClusterTemplate"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
