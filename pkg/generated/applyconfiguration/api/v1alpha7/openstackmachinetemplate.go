...
// OpenStackMachineTemplateApplyConfiguration represents an declarative configuration of the OpenStackMachineTemplate type for use
// with apply.
...
// OpenStackMachineTemplate constructs an declarative configuration of the OpenStackMachineTemplate type for use with
// apply.
func OpenStackMachineTemplate(name, namespace string) *OpenStackMachineTemplateApplyConfiguration {
	...
	b.WithKind("OpenStackMachineTemplate")
...
func extractOpenStackMachineTemplate(openStackMachineTemplate *apiv1alpha7.OpenStackMachineTemplate, fieldManager string, subresource string) (*OpenStackMachineTemplateApplyConfiguration, error) {
	b := &OpenStackMachineTemplateApplyConfiguration{}
	err := managedfields.ExtractInto(openStackMachineTemplate, internal.Parser().Type("io.k8s.sigs.cluster-api-provider-openstack.api.v1alpha7.OpenStackMachineTemplate"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(openStackMachineTemplate.Name)
	b.WithNamespace(openStackMachineTemplate.Namespace)
...
func (b *OpenStackMachineTemplateApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
