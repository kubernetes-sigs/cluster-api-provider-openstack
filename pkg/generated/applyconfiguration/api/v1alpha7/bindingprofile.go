...
// WithOVSHWOffload sets the OVSHWOffload field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the OVSHWOffload field is set to the value of the last call.
func (b *BindingProfileApplyConfiguration) WithOVSHWOffload(value bool) *BindingProfileApplyConfiguration {
	b.OVSHWOffload = &value
	return b
}
