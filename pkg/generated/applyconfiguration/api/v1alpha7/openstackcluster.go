...
// OpenStackClusterApplyConfiguration represents an declarative configuration of the OpenStackCluster type for use
// with apply.
...
// OpenStackCluster constructs an declarative configuration of the OpenStackCluster type for use with
// apply.
...
func extractOpenStackCluster(openStackCluster *apiv1alpha7.OpenStackCluster, fieldManager string, subresource string) (*OpenStackClusterApplyConfiguration, error) {
	b := &OpenStackClusterApplyConfiguration{}
	err := managedfields.ExtractInto(openStackCluster, internal.Parser().Type("io.k8s.sigs.cluster-api-provider-openstack.api.v1alpha7.OpenStackCluster"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
