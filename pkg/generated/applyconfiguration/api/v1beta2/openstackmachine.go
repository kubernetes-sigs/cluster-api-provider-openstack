...
func ExtractOpenStackMachineFrom(openStackMachine *apiv1beta2.OpenStackMachine, fieldManager string, subresource string) (*OpenStackMachineApplyConfiguration, error) {
	b := &OpenStackMachineApplyConfiguration{}
	err := managedfields.ExtractInto(openStackMachine, internal.Parser().Type("io.k8s.sigs.cluster-api-provider-openstack.api.v1beta2.OpenStackMachine"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractOpenStackMachine(openStackMachine *apiv1beta2.OpenStackMachine, fieldManager string) (*OpenStackMachineApplyConfiguration, error) {
...
func ExtractOpenStackMachineStatus(openStackMachine *apiv1beta2.OpenStackMachine, fieldManager string) (*OpenStackMachineApplyConfiguration, error) {
...
func (b *OpenStackMachineApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *OpenStackMachineApplyConfiguration) GetAPIVersion() *string {
...
func (b *OpenStackMachineApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
