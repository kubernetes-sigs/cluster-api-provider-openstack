...
func extractOpenStackMachine(openStackMachine *apiv1beta2.OpenStackMachine, fieldManager string, subresource string) (*OpenStackMachineApplyConfiguration, error) {
	b := &OpenStackMachineApplyConfiguration{}
