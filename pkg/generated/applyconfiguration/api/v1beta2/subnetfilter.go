...
func (b *SubnetFilterApplyConfiguration) WithTags(values ...apiv1beta2.NeutronTag) *SubnetFilterApplyConfiguration {
	for i := range values {
...
func (b *SubnetFilterApplyConfiguration) WithTagsAny(values ...apiv1beta2.NeutronTag) *SubnetFilterApplyConfiguration {
	for i := range values {
...
func (b *SubnetFilterApplyConfiguration) WithNotTags(values ...apiv1beta2.NeutronTag) *SubnetFilterApplyConfiguration {
	for i := range values {
...
func (b *SubnetFilterApplyConfiguration) WithNotTagsAny(values ...apiv1beta2.NeutronTag) *SubnetFilterApplyConfiguration {
	for i := range values {
