...
type FilterByNeutronTagsApplyConfiguration struct {
	Tags       []apiv1beta2.NeutronTag `json:"tags,omitempty"`
	TagsAny    []apiv1beta2.NeutronTag `json:"tagsAny,omitempty"`
	NotTags    []apiv1beta2.NeutronTag `json:"notTags,omitempty"`
	NotTagsAny []apiv1beta2.NeutronTag `json:"notTagsAny,omitempty"`
}
...
func (b *FilterByNeutronTagsApplyConfiguration) WithTags(values ...apiv1beta2.NeutronTag) *FilterByNeutronTagsApplyConfiguration {
	for i := range values {
...
func (b *FilterByNeutronTagsApplyConfiguration) WithTagsAny(values ...apiv1beta2.NeutronTag) *FilterByNeutronTagsApplyConfiguration {
	for i := range values {
...
func (b *FilterByNeutronTagsApplyConfiguration) WithNotTags(values ...apiv1beta2.NeutronTag) *FilterByNeutronTagsApplyConfiguration {
	for i := range values {
...
func (b *FilterByNeutronTagsApplyConfiguration) WithNotTagsAny(values ...apiv1beta2.NeutronTag) *FilterByNeutronTagsApplyConfiguration {
	for i := range values {
