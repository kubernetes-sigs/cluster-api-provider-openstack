...
func (b *RouterFilterApplyConfiguration) WithTags(values ...apiv1beta2.NeutronTag) *RouterFilterApplyConfiguration {
	for i := range values {
...
func (b *RouterFilterApplyConfiguration) WithTagsAny(values ...apiv1beta2.NeutronTag) *RouterFilterApplyConfiguration {
	for i := range values {
...
func (b *RouterFilterApplyConfiguration) WithNotTags(values ...apiv1beta2.NeutronTag) *RouterFilterApplyConfiguration {
	for i := range values {
...
func (b *RouterFilterApplyConfiguration) WithNotTagsAny(values ...apiv1beta2.NeutronTag) *RouterFilterApplyConfiguration {
	for i := range values {
