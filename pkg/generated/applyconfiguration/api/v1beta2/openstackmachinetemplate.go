...
func ExtractOpenStackMachineTemplateFrom(openStackMachineTemplate *apiv1beta2.OpenStackMachineTemplate, fieldManager string, subresource string) (*OpenStackMachineTemplateApplyConfiguration, error) {
	b := &OpenStackMachineTemplateApplyConfiguration{}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractOpenStackMachineTemplate(openStackMachineTemplate *apiv1beta2.OpenStackMachineTemplate, fieldManager string) (*OpenStackMachineTemplateApplyConfiguration, error) {
...
func ExtractOpenStackMachineTemplateStatus(openStackMachineTemplate *apiv1beta2.OpenStackMachineTemplate, fieldManager string) (*OpenStackMachineTemplateApplyConfiguration, error) {
