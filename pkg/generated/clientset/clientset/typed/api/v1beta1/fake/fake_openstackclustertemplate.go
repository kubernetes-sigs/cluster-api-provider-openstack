...
var openstackclustertemplatesResource = v1beta1.SchemeGroupVersion.WithResource("openstackclustertemplates")

var openstackclustertemplatesKind = v1beta1.SchemeGroupVersion.WithKind("OpenStackClusterTemplate")
...
func (c *FakeOpenStackClusterTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.OpenStackClusterTemplate, err error) {
	emptyResult := &v1beta1.OpenStackClusterTemplate{}
	obj, err := c.Fake.
	...
	return obj.(*v1beta1.OpenStackClusterTemplate), err
}

// List takes label and field selectors, and returns the list of OpenStackClusterTemplates that match those selectors.
func (c *FakeOpenStackClusterTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.OpenStackClusterTemplateList, err error) {
	emptyResult := &v1beta1.OpenStackClusterTemplateList{}
	obj, err := c.Fake.
	...
	list := &v1beta1.OpenStackClusterTemplateList{ListMeta: obj.(*v1beta1.OpenStackClusterTemplateList).ListMeta}
	for _, item := range obj.(*v1beta1.OpenStackClusterTemplateList).Items {
...
func (c *FakeOpenStackClusterTemplates) Create(ctx context.Context, openStackClusterTemplate *v1beta1.OpenStackClusterTemplate, opts v1.CreateOptions) (result *v1beta1.OpenStackClusterTemplate, err error) {
	emptyResult := &v1beta1.OpenStackClusterTemplate{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackClusterTemplates) Update(ctx context.Context, openStackClusterTemplate *v1beta1.OpenStackClusterTemplate, opts v1.UpdateOptions) (result *v1beta1.OpenStackClusterTemplate, err error) {
	emptyResult := &v1beta1.OpenStackClusterTemplate{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackClusterTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(openstackclustertemplatesResource, c.ns, name, opts), &v1beta1.OpenStackClusterTemplate{})
...
func (c *FakeOpenStackClusterTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.OpenStackClusterTemplateList{})
	return err
}

// Patch applies the patch and returns the patched openStackClusterTemplate.
func (c *FakeOpenStackClusterTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.OpenStackClusterTemplate, err error) {
	emptyResult := &v1beta1.OpenStackClusterTemplate{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackClusterTemplates) Apply(ctx context.Context, openStackClusterTemplate *apiv1beta1.OpenStackClusterTemplateApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.OpenStackClusterTemplate, err error) {
