...
var openstackmachinesResource = v1alpha6.SchemeGroupVersion.WithResource("openstackmachines")

var openstackmachinesKind = v1alpha6.SchemeGroupVersion.WithKind("OpenStackMachine")
...
func (c *FakeOpenStackMachines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha6.OpenStackMachine, err error) {
	emptyResult := &v1alpha6.OpenStackMachine{}
	obj, err := c.Fake.
	...
	return obj.(*v1alpha6.OpenStackMachine), err
}

// List takes label and field selectors, and returns the list of OpenStackMachines that match those selectors.
func (c *FakeOpenStackMachines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha6.OpenStackMachineList, err error) {
	emptyResult := &v1alpha6.OpenStackMachineList{}
	obj, err := c.Fake.
	...
	list := &v1alpha6.OpenStackMachineList{ListMeta: obj.(*v1alpha6.OpenStackMachineList).ListMeta}
	for _, item := range obj.(*v1alpha6.OpenStackMachineList).Items {
...
func (c *FakeOpenStackMachines) Create(ctx context.Context, openStackMachine *v1alpha6.OpenStackMachine, opts v1.CreateOptions) (result *v1alpha6.OpenStackMachine, err error) {
	emptyResult := &v1alpha6.OpenStackMachine{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackMachines) Update(ctx context.Context, openStackMachine *v1alpha6.OpenStackMachine, opts v1.UpdateOptions) (result *v1alpha6.OpenStackMachine, err error) {
	emptyResult := &v1alpha6.OpenStackMachine{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackMachines) UpdateStatus(ctx context.Context, openStackMachine *v1alpha6.OpenStackMachine, opts v1.UpdateOptions) (result *v1alpha6.OpenStackMachine, err error) {
	emptyResult := &v1alpha6.OpenStackMachine{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackMachines) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(openstackmachinesResource, c.ns, name, opts), &v1alpha6.OpenStackMachine{})
...
func (c *FakeOpenStackMachines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha6.OpenStackMachineList{})
	return err
}

// Patch applies the patch and returns the patched openStackMachine.
func (c *FakeOpenStackMachines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha6.OpenStackMachine, err error) {
	emptyResult := &v1alpha6.OpenStackMachine{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackMachines) Apply(ctx context.Context, openStackMachine *apiv1alpha6.OpenStackMachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha6.OpenStackMachine, err error) {
...
func (c *FakeOpenStackMachines) ApplyStatus(ctx context.Context, openStackMachine *apiv1alpha6.OpenStackMachineApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha6.OpenStackMachine, err error) {
	if openStackMachine == nil {
		return nil, fmt.Errorf("openStackMachine provided to Apply must not be nil")
	}
	data, err := json.Marshal(openStackMachine)
