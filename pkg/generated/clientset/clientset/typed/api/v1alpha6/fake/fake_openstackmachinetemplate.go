...
var openstackmachinetemplatesResource = v1alpha6.SchemeGroupVersion.WithResource("openstackmachinetemplates")

var openstackmachinetemplatesKind = v1alpha6.SchemeGroupVersion.WithKind("OpenStackMachineTemplate")
...
func (c *FakeOpenStackMachineTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha6.OpenStackMachineTemplate, err error) {
	emptyResult := &v1alpha6.OpenStackMachineTemplate{}
	obj, err := c.Fake.
	...
	return obj.(*v1alpha6.OpenStackMachineTemplate), err
}

// List takes label and field selectors, and returns the list of OpenStackMachineTemplates that match those selectors.
func (c *FakeOpenStackMachineTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha6.OpenStackMachineTemplateList, err error) {
	emptyResult := &v1alpha6.OpenStackMachineTemplateList{}
	obj, err := c.Fake.
	...
	list := &v1alpha6.OpenStackMachineTemplateList{ListMeta: obj.(*v1alpha6.OpenStackMachineTemplateList).ListMeta}
	for _, item := range obj.(*v1alpha6.OpenStackMachineTemplateList).Items {
...
func (c *FakeOpenStackMachineTemplates) Create(ctx context.Context, openStackMachineTemplate *v1alpha6.OpenStackMachineTemplate, opts v1.CreateOptions) (result *v1alpha6.OpenStackMachineTemplate, err error) {
	emptyResult := &v1alpha6.OpenStackMachineTemplate{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackMachineTemplates) Update(ctx context.Context, openStackMachineTemplate *v1alpha6.OpenStackMachineTemplate, opts v1.UpdateOptions) (result *v1alpha6.OpenStackMachineTemplate, err error) {
	emptyResult := &v1alpha6.OpenStackMachineTemplate{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackMachineTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(openstackmachinetemplatesResource, c.ns, name, opts), &v1alpha6.OpenStackMachineTemplate{})
...
func (c *FakeOpenStackMachineTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha6.OpenStackMachineTemplateList{})
	return err
}

// Patch applies the patch and returns the patched openStackMachineTemplate.
func (c *FakeOpenStackMachineTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha6.OpenStackMachineTemplate, err error) {
	emptyResult := &v1alpha6.OpenStackMachineTemplate{}
	obj, err := c.Fake.
...
func (c *FakeOpenStackMachineTemplates) Apply(ctx context.Context, openStackMachineTemplate *apiv1alpha6.OpenStackMachineTemplateApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha6.OpenStackMachineTemplate, err error) {
