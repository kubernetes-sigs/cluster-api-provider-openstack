...
type OpenStackMachineTemplateLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha6.OpenStackMachineTemplate, err error)
...
type openStackMachineTemplateLister struct {
	listers.ResourceIndexer[*v1alpha6.OpenStackMachineTemplate]
}
...
func NewOpenStackMachineTemplateLister(indexer cache.Indexer) OpenStackMachineTemplateLister {
	return &openStackMachineTemplateLister{listers.New[*v1alpha6.OpenStackMachineTemplate](indexer, v1alpha6.Resource("openstackmachinetemplate"))}
}

// OpenStackMachineTemplates returns an object that can list and get OpenStackMachineTemplates.
func (s *openStackMachineTemplateLister) OpenStackMachineTemplates(namespace string) OpenStackMachineTemplateNamespaceLister {
	return openStackMachineTemplateNamespaceLister{listers.NewNamespaced[*v1alpha6.OpenStackMachineTemplate](s.ResourceIndexer, namespace)}
}
...
type OpenStackMachineTemplateNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha6.OpenStackMachineTemplate, error)
