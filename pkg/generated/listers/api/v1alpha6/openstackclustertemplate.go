...
type OpenStackClusterTemplateLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha6.OpenStackClusterTemplate, err error)
...
type openStackClusterTemplateLister struct {
	listers.ResourceIndexer[*v1alpha6.OpenStackClusterTemplate]
}
...
func NewOpenStackClusterTemplateLister(indexer cache.Indexer) OpenStackClusterTemplateLister {
	return &openStackClusterTemplateLister{listers.New[*v1alpha6.OpenStackClusterTemplate](indexer, v1alpha6.Resource("openstackclustertemplate"))}
}

// OpenStackClusterTemplates returns an object that can list and get OpenStackClusterTemplates.
func (s *openStackClusterTemplateLister) OpenStackClusterTemplates(namespace string) OpenStackClusterTemplateNamespaceLister {
	return openStackClusterTemplateNamespaceLister{listers.NewNamespaced[*v1alpha6.OpenStackClusterTemplate](s.ResourceIndexer, namespace)}
}
...
type OpenStackClusterTemplateNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha6.OpenStackClusterTemplate, error)
