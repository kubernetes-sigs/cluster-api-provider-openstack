...
type OpenStackMachineLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha7.OpenStackMachine, err error)
...
type openStackMachineLister struct {
	listers.ResourceIndexer[*apiv1alpha7.OpenStackMachine]
}
...
func NewOpenStackMachineLister(indexer cache.Indexer) OpenStackMachineLister {
	return &openStackMachineLister{listers.New[*apiv1alpha7.OpenStackMachine](indexer, apiv1alpha7.Resource("openstackmachine"))}
}

// OpenStackMachines returns an object that can list and get OpenStackMachines.
func (s *openStackMachineLister) OpenStackMachines(namespace string) OpenStackMachineNamespaceLister {
	return openStackMachineNamespaceLister{listers.NewNamespaced[*apiv1alpha7.OpenStackMachine](s.ResourceIndexer, namespace)}
}
...
type OpenStackMachineNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha7.OpenStackMachine, error)
