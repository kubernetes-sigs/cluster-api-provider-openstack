...
type OpenStackClusterLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha7.OpenStackCluster, err error)
...
type openStackClusterLister struct {
	listers.ResourceIndexer[*apiv1alpha7.OpenStackCluster]
}
...
func NewOpenStackClusterLister(indexer cache.Indexer) OpenStackClusterLister {
	return &openStackClusterLister{listers.New[*apiv1alpha7.OpenStackCluster](indexer, apiv1alpha7.Resource("openstackcluster"))}
}

// OpenStackClusters returns an object that can list and get OpenStackClusters.
func (s *openStackClusterLister) OpenStackClusters(namespace string) OpenStackClusterNamespaceLister {
	return openStackClusterNamespaceLister{listers.NewNamespaced[*apiv1alpha7.OpenStackCluster](s.ResourceIndexer, namespace)}
}
...
type OpenStackClusterNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha7.OpenStackCluster, error)
