...
type OpenStackMachineLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1beta2.OpenStackMachine, err error)
...
type openStackMachineLister struct {
	listers.ResourceIndexer[*apiv1beta2.OpenStackMachine]
}
...
func NewOpenStackMachineLister(indexer cache.Indexer) OpenStackMachineLister {
	return &openStackMachineLister{listers.New[*apiv1beta2.OpenStackMachine](indexer, apiv1beta2.Resource("openstackmachine"))}
}

// OpenStackMachines returns an object that can list and get OpenStackMachines.
func (s *openStackMachineLister) OpenStackMachines(namespace string) OpenStackMachineNamespaceLister {
	return openStackMachineNamespaceLister{listers.NewNamespaced[*apiv1beta2.OpenStackMachine](s.ResourceIndexer, namespace)}
}
...
type OpenStackMachineNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1beta2.OpenStackMachine, error)
