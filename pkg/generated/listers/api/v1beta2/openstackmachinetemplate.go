...
type OpenStackMachineTemplateLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1beta2.OpenStackMachineTemplate, err error)
...
type openStackMachineTemplateLister struct {
	listers.ResourceIndexer[*apiv1beta2.OpenStackMachineTemplate]
}
...
func NewOpenStackMachineTemplateLister(indexer cache.Indexer) OpenStackMachineTemplateLister {
	return &openStackMachineTemplateLister{listers.New[*apiv1beta2.OpenStackMachineTemplate](indexer, apiv1beta2.Resource("openstackmachinetemplate"))}
}

// OpenStackMachineTemplates returns an object that can list and get OpenStackMachineTemplates.
func (s *openStackMachineTemplateLister) OpenStackMachineTemplates(namespace string) OpenStackMachineTemplateNamespaceLister {
	return openStackMachineTemplateNamespaceLister{listers.NewNamespaced[*apiv1beta2.OpenStackMachineTemplate](s.ResourceIndexer, namespace)}
}
...
type OpenStackMachineTemplateNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1beta2.OpenStackMachineTemplate, error)
