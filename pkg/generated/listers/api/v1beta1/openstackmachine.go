...
type OpenStackMachineLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.OpenStackMachine, err error)
...
type openStackMachineLister struct {
	listers.ResourceIndexer[*v1beta1.OpenStackMachine]
}
...
func NewOpenStackMachineLister(indexer cache.Indexer) OpenStackMachineLister {
	return &openStackMachineLister{listers.New[*v1beta1.OpenStackMachine](indexer, v1beta1.Resource("openstackmachine"))}
}

// OpenStackMachines returns an object that can list and get OpenStackMachines.
func (s *openStackMachineLister) OpenStackMachines(namespace string) OpenStackMachineNamespaceLister {
	return openStackMachineNamespaceLister{listers.NewNamespaced[*v1beta1.OpenStackMachine](s.ResourceIndexer, namespace)}
}
...
type OpenStackMachineNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1beta1.OpenStackMachine, error)
