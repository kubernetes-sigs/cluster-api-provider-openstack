...
var (
	_ webhook.CustomValidator = &openStackClusterTemplateWebhook{}
	_ webhook.CustomDefaulter = &openStackClusterTemplateWebhook{}
)

func (*openStackClusterTemplateWebhook) Default(_ context.Context, objRaw runtime.Object) error {
	...
	if newObj.Spec.Template.Spec.IdentityRef != nil && newObj.Spec.Template.Spec.IdentityRef.Kind != defaultIdentityRefKind {
	...
	return apierrors.NewInvalid(newObj.GroupVersionKind().GroupKind(), newObj.Name, allErrs)
}
