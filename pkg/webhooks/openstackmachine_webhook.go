...
var (
	_ webhook.CustomValidator = &openStackMachineWebhook{}
	_ webhook.CustomDefaulter = &openStackMachineWebhook{}
)

// Default implements webhook.CustomDefaulter.
func (*openStackMachineWebhook) Default(_ context.Context, objRaw runtime.Object) error {
	...
	if newObj.Spec.IdentityRef != nil && newObj.Spec.IdentityRef.Kind != defaultIdentityRefKind {
		newObj.Spec.IdentityRef.Kind = defaultIdentityRefKind
	}
