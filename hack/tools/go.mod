...
require (
	...
	sigs.k8s.io/cluster-api/hack/tools v1.11.0
...
replace sigs.k8s.io/cluster-api/hack/tools => github.com/shiftstack/cluster-api/hack/tools v1.0.1-0.20250703144234-2d58e5550260
