...
- path: /tmp/devstack-common.sh
  ...
  content: |
    ...
    function upload_images {
      ...
      su - stack -c "source /opt/stack/devstack/openrc admin admin && /opt/stack/devstack/tools/upload_image.sh https://github.com/hidekazuna/cluster-api-provider-openstack-images/releases/download/v1.20.10/ubuntu-2004-kube-v1.20.10.qcow2"
