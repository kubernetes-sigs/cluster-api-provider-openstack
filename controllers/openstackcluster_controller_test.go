...
func TestConfiguredClusterSubnetParamsUsesPrimarySubnetAsLegacyFallback(t *testing.T) {
	...
	if len(got) != 2 {
		t.Fatalf("configuredClusterSubnetParams() returned %d subnets, want 2", len(got))
	}
