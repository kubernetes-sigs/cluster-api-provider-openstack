...
## Changes since v0.14.8
## :chart_with_upwards_trend: Overview
- 184 new commits merged
...
- Add missing variable to Makefile (#3367)
...
## :seedling: Others
- (deps): Bump the all-go-mod-patch-and-minor group plus linter fixes (#3336)
...
- Bump google.golang.org/grpc to v1.83.2 (#3361)
...
- E2E: Pin glance to working commit (#3354)
...
- Revert "E2E: Pin glance to working commit" (#3359)
...
- github.com/gophercloud/gophercloud/v2: [v2.10.0 → v2.14.0](https://github.com/gophercloud/gophercloud/compare/v2.10.0...v2.14.0)
...
- github.com/onsi/ginkgo/v2: [v2.28.2 → v2.32.1](https://github.com/onsi/ginkgo/compare/v2.28.2...v2.32.1)
- github.com/onsi/gomega: [v1.42.0 → v1.43.0](https://github.com/onsi/gomega/compare/v1.42.0...v1.43.0)
...
- golang.org/x/telemetry: bd525da → 49f421f
...
- k8s.io/api: v0.34.10 → v0.36.4
- k8s.io/apiextensions-apiserver: v0.34.10 → v0.36.4
- k8s.io/apimachinery: v0.34.10 → v0.36.4
- k8s.io/apiserver: v0.34.10 → v0.36.4
- k8s.io/client-go: v0.34.10 → v0.36.4
- k8s.io/cluster-bootstrap: v0.34.2 → v0.36.3
- k8s.io/code-generator: v0.34.10 → v0.36.4
- k8s.io/component-base: v0.34.10 → v0.36.4
- k8s.io/gengo/v2: 85fd79d → ec3ebc5
- k8s.io/klog/v2: v2.130.1 → v2.140.0
- k8s.io/kms: v0.34.10 → v0.36.4
...
- sigs.k8s.io/cluster-api/test: v1.12.11 → v1.14.1
- sigs.k8s.io/cluster-api: v1.12.11 → v1.14.1
- sigs.k8s.io/controller-runtime: v0.22.5 → v0.24.1
- sigs.k8s.io/json: cfa47c3 → 2d32026
- sigs.k8s.io/kind: v0.31.0 → v0.33.0
