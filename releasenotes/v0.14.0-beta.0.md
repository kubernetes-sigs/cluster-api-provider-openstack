...
- github.com/k-orc/openstack-resource-controller/v2: [v2.3.0 → v2.4.0](https://github.com/k-orc/openstack-resource-controller/compare/v2.3.0...v2.4.0)
...
- sigs.k8s.io/cluster-api: v1.11.4 → v1.12.1
