🚨 This is a BETA RELEASE. Use it only for testing purposes. If you find any bugs, file an [issue](https://github.com/kubernetes-sigs/cluster-api-provider-openstack/issues/new).
<details>
...
:book: Additionally, there have been 4 contributions to our documentation and book. (#3098, #3110, #3111, #3267) 
...
- k8s.io/api: v0.34.9 → v0.35.7
- k8s.io/apiextensions-apiserver: v0.34.9 → v0.35.7
- k8s.io/apimachinery: v0.34.9 → v0.35.7
- k8s.io/apiserver: v0.34.9 → v0.35.7
- k8s.io/client-go: v0.34.9 → v0.35.7
- k8s.io/cluster-bootstrap: v0.34.2 → v0.35.4
- k8s.io/code-generator: v0.34.9 → v0.35.7
- k8s.io/component-base: v0.34.9 → v0.35.7
- k8s.io/gengo/v2: 85fd79d → ec3ebc5
- k8s.io/kms: v0.34.9 → v0.35.7
- k8s.io/kube-openapi: f3f2b99 → 589584f
- k8s.io/utils: 4c0f3b2 → bc988d5
- sigs.k8s.io/cluster-api/test: v1.12.8 → v1.13.4
- sigs.k8s.io/cluster-api: v1.12.8 → v1.13.4
