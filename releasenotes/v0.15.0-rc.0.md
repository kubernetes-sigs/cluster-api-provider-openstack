🚨 This is a RELEASE CANDIDATE. Use it only for testing purposes. If you find any bugs, file an [issue](https://github.com/kubernetes-sigs/cluster-api-provider-openstack/issues/new).
<details>
...
- Allow unconditional providerID updates in OpenStackMachine (#3265)
- Fix(openstackserver): recover from Nova ERROR state (#3300)
- Guard Neutron tagging by extension support (#3319)
...
- Bump go version to 1.26.5 (#3257)
- Bump Go version to 1.26.6 (#3311)
...
- Bump ORC to v2.6.0 in E2E (#3242)
- Bump x/net to v0.55.0 (#3201)
- CI: Correctly pin to v1.13 latest (#3219)
- Configure dependabot to avoid golang bumps (#3280)
...
- Prevent go requirement changes (#3290)
...
- Update gcb-docker-gcloud image registry and digest (#3305)
...
- :rocket: Release v0.14.7 (#3302)

:book: Additionally, there have been 5 contributions to our documentation and book. (#3098, #3110, #3111, #3267, #3310) 
...
### Changed
- github.com/GoogleCloudPlatform/opentelemetry-operations-go/detectors/gcp: [v1.30.0 → v1.32.0](https://github.com/GoogleCloudPlatform/opentelemetry-operations-go/compare/detectors/gcp/v1.30.0...detectors/gcp/v1.32.0)
...
- github.com/golang-jwt/jwt/v5: [v5.2.2 → v5.3.1](https://github.com/golang-jwt/jwt/compare/v5.2.2...v5.3.1)
...
- github.com/gophercloud/gophercloud/v2: [v2.10.0 → v2.13.0](https://github.com/gophercloud/gophercloud/compare/v2.10.0...v2.13.0)
...
- github.com/moby/moby/api: [v1.54.1 → v1.55.0](https://github.com/moby/moby/compare/api/v1.54.1...api/v1.55.0)
- github.com/moby/moby/client: [v0.4.0 → v0.5.1](https://github.com/moby/moby/compare/client/v0.4.0...client/v0.5.1)
...
- github.com/onsi/ginkgo/v2: [v2.28.2 → v2.32.0](https://github.com/onsi/ginkgo/compare/v2.28.2...v2.32.0)
...
- github.com/prometheus/common: [v0.66.1 → v0.70.1](https://github.com/prometheus/common/compare/v0.66.1...v0.70.1)
- github.com/prometheus/procfs: [v0.16.1 → v0.21.1](https://github.com/prometheus/procfs/compare/v0.16.1...v0.21.1)
...
- go.etcd.io/etcd/api/v3: v3.6.6 → v3.6.14
- go.etcd.io/etcd/client/pkg/v3: v3.6.6 → v3.6.14
- go.etcd.io/etcd/client/v3: v3.6.6 → v3.6.14
- go.etcd.io/etcd/pkg/v3: v3.6.4 → v3.6.8
- go.etcd.io/etcd/server/v3: v3.6.4 → v3.6.8
...
- golang.org/x/exp: b2144cd → 944ab1f
...
- google.golang.org/genproto/googleapis/api: 8636f87 → afd174a
- google.golang.org/genproto/googleapis/rpc: 8636f87 → afd174a
- google.golang.org/grpc: v1.79.3 → v1.82.1
- gopkg.in/evanphx/json-patch.v4: v4.12.0 → v4.13.0
- k8s.io/api: v0.34.10 → v0.36.3
- k8s.io/apiextensions-apiserver: v0.34.10 → v0.36.3
- k8s.io/apimachinery: v0.34.10 → v0.36.3
- k8s.io/apiserver: v0.34.10 → v0.36.3
- k8s.io/client-go: v0.34.10 → v0.36.3
- k8s.io/cluster-bootstrap: v0.34.2 → v0.36.3
- k8s.io/code-generator: v0.34.10 → v0.36.3
- k8s.io/component-base: v0.34.10 → v0.36.3
- k8s.io/gengo/v2: 85fd79d → ec3ebc5
- k8s.io/klog/v2: v2.130.1 → v2.140.0
- k8s.io/kms: v0.34.10 → v0.36.3
...
- sigs.k8s.io/cluster-api/test: v1.12.10 → v1.14.0
- sigs.k8s.io/cluster-api: v1.12.10 → v1.14.0
