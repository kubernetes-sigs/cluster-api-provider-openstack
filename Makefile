...
test-e2e-image-prerequisites:
	docker pull k8s.gcr.io/cluster-api/cluster-api-controller:v1.0.0
	docker pull k8s.gcr.io/cluster-api/kubeadm-bootstrap-controller:v1.0.0
	docker pull k8s.gcr.io/cluster-api/kubeadm-control-plane-controller:v1.0.0
