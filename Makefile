...
test-e2e-image-prerequisites:
	docker pull registry.k8s.io/cluster-api/cluster-api-controller:v1.8.7
	docker pull registry.k8s.io/cluster-api/kubeadm-bootstrap-controller:v1.8.7
	docker pull registry.k8s.io/cluster-api/kubeadm-control-plane-controller:v1.8.7
