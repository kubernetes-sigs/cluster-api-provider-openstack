...
test-e2e-image-prerequisites:
	docker pull gcr.io/k8s-staging-cluster-api/cluster-api-controller:v1.0.5
	docker pull gcr.io/k8s-staging-cluster-api/kubeadm-bootstrap-controller:v1.0.5
	docker pull gcr.io/k8s-staging-cluster-api/kubeadm-control-plane-controller:v1.0.5
