...
print_help()
{
  echo "$SCRIPT - generates a provider-specific YAML files"
  echo ""
  echo "Usage:"
...
mkdir -p $PWD/$OUTPUT
cp -n $PWD/templates/cluster.yaml $PWD/$OUTPUT/cluster.yaml || true
cp -n $PWD/templates/machines.yaml $PWD/$OUTPUT/machines.yaml || true
...
kubectl kustomize $PWD/templates/namespace > $PWD/$OUTPUT/provider-components.yaml
echo "---" >> $PWD/$OUTPUT/provider-components.yaml

echo "---" >> $PWD/$OUTPUT/provider-components.yaml
kubectl kustomize $PWD/templates/clouds-secrets >> $PWD/$OUTPUT/provider-components.yaml
echo "---" >> $PWD/$OUTPUT/provider-components.yaml
