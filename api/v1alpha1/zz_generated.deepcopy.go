...
func (in *OpenStackServerSpec) DeepCopyInto(out *OpenStackServerSpec) {
	*out = *in
	...
	if in.SecurityGroups != nil {
		...
		*out = make([]v1beta2.SecurityGroupParam, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ServerGroup != nil {
		...
		*out = new(v1beta2.ServerGroupParam)
		(*in).DeepCopyInto(*out)
	}
	if in.ServerMetadata != nil {
		in, out := &in.ServerMetadata, &out.ServerMetadata
		*out = make([]v1beta2.ServerMetadata, len(*in))
		copy(*out, *in)
	}
	if in.Tags != nil {
...
func (in *ServerResources) DeepCopyInto(out *ServerResources) {
	*out = *in
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
		*out = make([]v1beta2.PortStatus, len(*in))
		copy(*out, *in)
	}
}
