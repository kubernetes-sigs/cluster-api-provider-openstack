...
func (in *APIServerLoadBalancer) DeepCopyInto(out *APIServerLoadBalancer) {
	*out = *in
	...
	if in.AvailabilityZoneSubnets != nil {
		in, out := &in.AvailabilityZoneSubnets, &out.AvailabilityZoneSubnets
	...
	if in.AllowCrossAZLoadBalancerMembers != nil {
		in, out := &in.AllowCrossAZLoadBalancerMembers, &out.AllowCrossAZLoadBalancerMembers
		*out = new(bool)
		**out = **in
	}
}
...
func (in *OpenStackClusterStatus) DeepCopyInto(out *OpenStackClusterStatus) {
	*out = *in
	...
	if in.APIServerLoadBalancers != nil {
		in, out := &in.APIServerLoadBalancers, &out.APIServerLoadBalancers
