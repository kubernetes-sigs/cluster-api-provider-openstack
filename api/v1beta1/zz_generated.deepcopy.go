...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenStackServerResources) DeepCopyInto(out *OpenStackServerResources) {
	*out = *in
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
		*out = make([]PortStatus, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenStackServerResources.
func (in *OpenStackServerResources) DeepCopy() *OpenStackServerResources {
	if in == nil {
		return nil
	}
	out := new(OpenStackServerResources)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenStackServerStatus) DeepCopyInto(out *OpenStackServerStatus) {
	*out = *in
	...
	if in.Resolved != nil {
		in, out := &in.Resolved, &out.Resolved
		*out = new(ResolvedOpenStackServerSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
	...
	if in.FailureReason != nil {
		in, out := &in.FailureReason, &out.FailureReason
		*out = new(errors.ServerStatusError)
		**out = **in
	}
	if in.FailureMessage != nil {
		in, out := &in.FailureMessage, &out.FailureMessage
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResolvedOpenStackServerSpec) DeepCopyInto(out *ResolvedOpenStackServerSpec) {
	*out = *in
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
		*out = make([]ResolvedPortSpec, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResolvedOpenStackServerSpec.
func (in *ResolvedOpenStackServerSpec) DeepCopy() *ResolvedOpenStackServerSpec {
	if in == nil {
		return nil
	}
	out := new(ResolvedOpenStackServerSpec)
