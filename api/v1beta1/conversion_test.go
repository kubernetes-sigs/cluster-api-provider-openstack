...
func TestOpenStackClusterConversion(t *testing.T) {
	...
	// Verify deprecated fields NOT present in v1beta2
	// (no Ready, FailureReason, FailureMessage fields in v1beta2 struct)
...
func TestOpenStackMachineConversion(t *testing.T) {
	...
	g.Expect((*string)(dst.Spec.Image.Filter.Name)).To(Equal(ptr.To("ubuntu-22.04")))
