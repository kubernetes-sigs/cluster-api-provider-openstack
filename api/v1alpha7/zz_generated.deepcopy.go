...
func (in *SecurityGroupsSpec) DeepCopyInto(out *SecurityGroupsSpec) {
	*out = *in
	if in.AdditionalBastionSecurityGroupRules != nil {
		in, out := &in.AdditionalBastionSecurityGroupRules, &out.AdditionalBastionSecurityGroupRules
		*out = make([]SecurityGroupRule, len(*in))
		copy(*out, *in)
	}
	if in.AdditionalControlPlaneSecurityGroupRules != nil {
		in, out := &in.AdditionalControlPlaneSecurityGroupRules, &out.AdditionalControlPlaneSecurityGroupRules
		*out = make([]SecurityGroupRule, len(*in))
		copy(*out, *in)
	}
	if in.AdditionalWorkerSecurityGroupRules != nil {
		in, out := &in.AdditionalWorkerSecurityGroupRules, &out.AdditionalWorkerSecurityGroupRules
		*out = make([]SecurityGroupRule, len(*in))
		copy(*out, *in)
	}
	if in.CNISecurityGroupRules != nil {
		in, out := &in.CNISecurityGroupRules, &out.CNISecurityGroupRules
		*out = make([]SecurityGroupRule, len(*in))
		copy(*out, *in)
	}
...
func (in *SecurityGroupsStatus) DeepCopyInto(out *SecurityGroupsStatus) {
	*out = *in
	in.BastionSecurityGroup.DeepCopyInto(&out.BastionSecurityGroup)
	in.ControlPlaneSecurityGroup.DeepCopyInto(&out.ControlPlaneSecurityGroup)
	in.WorkerSecurityGroup.DeepCopyInto(&out.WorkerSecurityGroup)
	in.CNISecurityGroup.DeepCopyInto(&out.CNISecurityGroup)
	if in.AdditionalSecurityGroups != nil {
		in, out := &in.AdditionalSecurityGroups, &out.AdditionalSecurityGroups
		*out = make([]SecurityGroup, len(*in))
		for i := range *in {
