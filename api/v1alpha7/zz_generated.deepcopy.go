...
func (in *OpenStackClusterSpec) DeepCopyInto(out *OpenStackClusterSpec) {
	*out = *in
	...
	in.WorkerFloatingIPConfig.DeepCopyInto(&out.WorkerFloatingIPConfig)
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make([]string, len(*in))
		copy(*out, *in)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkerFloatingIPConfig) DeepCopyInto(out *WorkerFloatingIPConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkerFloatingIPConfig.
func (in *WorkerFloatingIPConfig) DeepCopy() *WorkerFloatingIPConfig {
	if in == nil {
		return nil
	}
	out := new(WorkerFloatingIPConfig)
	in.DeepCopyInto(out)
	return out
}
