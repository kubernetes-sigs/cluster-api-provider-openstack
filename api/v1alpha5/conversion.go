...
func Convert_v1alpha5_PortOpts_To_v1alpha7_PortOpts(in *PortOpts, out *infrav1.PortOpts, s conversion.Scope) error {
	...
	if in.SecurityGroupFilters != nil {
		for _, v1alpha6SecurityGroupParam := range in.SecurityGroupFilters {
			...
			err = autoConvert_v1alpha5_SecurityGroupFilter_To_v1alpha7_SecurityGroupFilter(&v1alpha6SecurityGroupParam.Filter, &filter, s)
			if err != nil {
				return err
			}
...
// Value specs have been added in v1alpha7 but does not exist in v1alpha5.
func Convert_v1alpha7_PortOpts_To_v1alpha5_PortOpts(in *infrav1.PortOpts, out *PortOpts, s conversion.Scope) error {
	...
	if in.SecurityGroups != nil {
		...
		for _, inSecurityGroup := range *in.SecurityGroups {
			...
			err = autoConvert_v1alpha7_SecurityGroupFilter_To_v1alpha5_SecurityGroupFilter(&inSecurityGroup.Filter, &filter, s)
			if err != nil {
				return err
			}
