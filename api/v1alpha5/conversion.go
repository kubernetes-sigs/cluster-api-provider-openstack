...
func Convert_v1alpha5_Network_To_v1alpha7_NetworkStatusWithSubnets(in *Network, out *infrav1.NetworkStatusWithSubnets, _ conversion.Scope) error {
...
func Convert_v1alpha7_NetworkStatusWithSubnets_To_v1alpha5_Network(in *infrav1.NetworkStatusWithSubnets, out *Network, _ conversion.Scope) error {
	// v1alpha7 removes PortOpts, Router, and APIServerLoadBalancer
