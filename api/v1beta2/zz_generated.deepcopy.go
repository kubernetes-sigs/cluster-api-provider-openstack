...
func (in *APIServer) DeepCopyInto(out *APIServer) {
	*out = *in
	...
	if in.ManagedLoadBalancer != nil {
		in, out := &in.ManagedLoadBalancer, &out.ManagedLoadBalancer
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlavorParam) DeepCopyInto(out *FlavorParam) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlavorParam.
func (in *FlavorParam) DeepCopy() *FlavorParam {
	if in == nil {
		return nil
	}
	out := new(FlavorParam)
...
func (in *LoadBalancer) DeepCopyInto(out *LoadBalancer) {
	*out = *in
	...
	in.LoadBalancerNetwork.DeepCopyInto(&out.LoadBalancerNetwork)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedRouter) DeepCopyInto(out *ManagedRouter) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedRouter.
func (in *ManagedRouter) DeepCopy() *ManagedRouter {
	if in == nil {
		return nil
	}
...
func (in *ManagedSecurityGroups) DeepCopyInto(out *ManagedSecurityGroups) {
	*out = *in
	if in.ClusterNodesSecurityGroupRules != nil {
		in, out := &in.ClusterNodesSecurityGroupRules, &out.ClusterNodesSecurityGroupRules
...
func (in *OpenStackClusterSpec) DeepCopyInto(out *OpenStackClusterSpec) {
	*out = *in
	...
	in.PrimarySubnet.DeepCopyInto(&out.PrimarySubnet)
...
func (in *OpenStackClusterStatus) DeepCopyInto(out *OpenStackClusterStatus) {
	*out = *in
	...
	in.ExternalNetwork.DeepCopyInto(&out.ExternalNetwork)
	in.Router.DeepCopyInto(&out.Router)
	in.APIServerManagedLoadBalancer.DeepCopyInto(&out.APIServerManagedLoadBalancer)
	...
	out.ControlPlaneSecurityGroup = in.ControlPlaneSecurityGroup
	out.WorkerSecurityGroup = in.WorkerSecurityGroup
	out.BastionSecurityGroup = in.BastionSecurityGroup
	if in.Bastion != nil {
		in, out := &in.Bastion, &out.Bastion
		*out = new(BastionStatus)
		(*in).DeepCopyInto(*out)
...
func (in *OpenStackMachineSpec) DeepCopyInto(out *OpenStackMachineSpec) {
	*out = *in
	...
	in.ServerGroup.DeepCopyInto(&out.ServerGroup)
	out.IdentityRef = in.IdentityRef
