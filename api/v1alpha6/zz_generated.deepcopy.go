...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailureDomainDefinition) DeepCopyInto(out *FailureDomainDefinition) {
	*out = *in
	in.FailureDomain.DeepCopyInto(&out.FailureDomain)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailureDomainDefinition.
func (in *FailureDomainDefinition) DeepCopy() *FailureDomainDefinition {
	if in == nil {
		return nil
	}
	out := new(FailureDomainDefinition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenStackClusterSpec) DeepCopyInto(out *OpenStackClusterSpec) {
	*out = *in
	...
	if in.FailureDomains != nil {
		...
		*out = make([]FailureDomainDefinition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
