...
func Convert_v1alpha4_OpenStackClusterSpec_To_v1alpha7_OpenStackClusterSpec(in *OpenStackClusterSpec, out *infrav1.OpenStackClusterSpec, s conversion.Scope) error {
	...
	return autoConvert_v1alpha4_OpenStackClusterSpec_To_v1alpha7_OpenStackClusterSpec(in, out, s)
}

func Convert_v1alpha7_OpenStackClusterSpec_To_v1alpha4_OpenStackClusterSpec(in *infrav1.OpenStackClusterSpec, out *OpenStackClusterSpec, s conversion.Scope) error {
	...
	return autoConvert_v1alpha7_OpenStackClusterSpec_To_v1alpha4_OpenStackClusterSpec(in, out, s)
}
