...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Filter)(nil), (*v1beta1.NetworkFilter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_Filter_To_v1beta1_Filter(a.(*Filter), b.(*v1beta1.NetworkFilter), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.NetworkFilter)(nil), (*Filter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_Filter_To_v1alpha4_Filter(a.(*v1beta1.NetworkFilter), b.(*Filter), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*v1beta1.OpenStackMachineSpec)(nil), (*OpenStackMachineSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha4_Filter_To_v1beta1_Filter(in *Filter, out *v1beta1.NetworkFilter, s conversion.Scope) error {
	out.Name = in.Name
...
func Convert_v1alpha4_Filter_To_v1beta1_Filter(in *Filter, out *v1beta1.NetworkFilter, s conversion.Scope) error {
	return autoConvert_v1alpha4_Filter_To_v1beta1_Filter(in, out, s)
}

func autoConvert_v1beta1_Filter_To_v1alpha4_Filter(in *v1beta1.NetworkFilter, out *Filter, s conversion.Scope) error {
	out.Name = in.Name
	out.Description = in.Description
	out.ProjectID = in.ProjectID
	out.ID = in.ID
...
func Convert_v1beta1_Filter_To_v1alpha4_Filter(in *v1beta1.NetworkFilter, out *Filter, s conversion.Scope) error {
...
// Convert_v1alpha4_FixedIP_To_v1beta1_FixedIP is an autogenerated conversion function.
func Convert_v1alpha4_FixedIP_To_v1beta1_FixedIP(in *FixedIP, out *v1beta1.FixedIP, s conversion.Scope) error {
	return autoConvert_v1alpha4_FixedIP_To_v1beta1_FixedIP(in, out, s)
}
...
// Convert_v1beta1_FixedIP_To_v1alpha4_FixedIP is an autogenerated conversion function.
func Convert_v1beta1_FixedIP_To_v1alpha4_FixedIP(in *v1beta1.FixedIP, out *FixedIP, s conversion.Scope) error {
	return autoConvert_v1beta1_FixedIP_To_v1alpha4_FixedIP(in, out, s)
}
...
func autoConvert_v1alpha4_OpenStackClusterSpec_To_v1beta1_OpenStackClusterSpec(in *OpenStackClusterSpec, out *v1beta1.OpenStackClusterSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha4_Filter_To_v1beta1_Filter(&in.Network, &out.Network, s); err != nil {
		return err
	}
...
func autoConvert_v1beta1_OpenStackClusterSpec_To_v1alpha4_OpenStackClusterSpec(in *v1beta1.OpenStackClusterSpec, out *OpenStackClusterSpec, s conversion.Scope) error {
	out.CloudName = in.CloudName
	out.NodeCIDR = in.NodeCIDR
	if err := Convert_v1beta1_Filter_To_v1alpha4_Filter(&in.Network, &out.Network, s); err != nil {
		return err
	}
...
// Convert_v1beta1_OpenStackMachineSpec_To_v1alpha4_OpenStackMachineSpec is an autogenerated conversion function.
func Convert_v1beta1_OpenStackMachineSpec_To_v1alpha4_OpenStackMachineSpec(in *v1beta1.OpenStackMachineSpec, out *OpenStackMachineSpec, s conversion.Scope) error {
...
func autoConvert_v1alpha4_PortOpts_To_v1beta1_PortOpts(in *PortOpts, out *v1beta1.PortOpts, s conversion.Scope) error {
	...
	out.Tags = *(*[]string)(unsafe.Pointer(&in.Tags))
	err := Convert_v1alpha4_FixedIPs_To_v1beta1_FixedIPs(&in.FixedIPs, &out.FixedIPs, s)
	if err != nil {
		return err
	}
	return nil
...
func autoConvert_v1beta1_PortOpts_To_v1alpha4_PortOpts(in *v1beta1.PortOpts, out *PortOpts, s conversion.Scope) error {
	if in.Network != nil {
		if in.Network.ID != "" {
			...
			errors.InvalidMachineConfiguration("Cannot convert v1beta1 PortOpts to v1alpha4 PortOpts if ")
		}
	}
	out.NameSuffix = in.NameSuffix
	out.Description = in.Description
	...
	out.DisablePortSecurity = (*bool)(unsafe.Pointer(in.DisablePortSecurity))
	out.Tags = *(*[]string)(unsafe.Pointer(&in.Tags))
	err := Convert_v1beta1_FixedIPs_To_v1alpha4_FixedIPs(&in.FixedIPs, &out.FixedIPs, s)
	if err != nil {
		return err
	}
	return nil
...
// Convert_v1alpha4_PortOpts_To_v1beta1_PortOpts is not an autogenerated conversion function.
func Convert_v1alpha4_FixedIPs_To_v1beta1_FixedIPs(in *[]FixedIP, out *[]v1beta1.FixedIP, s conversion.Scope) error {
	return autoConvert_v1alpha4_FixedIPs_To_v1beta1_FixedIPs(in, out, s)
}

func autoConvert_v1alpha4_FixedIPs_To_v1beta1_FixedIPs(in *[]FixedIP, out *[]v1beta1.FixedIP, s conversion.Scope) error {
	fipList := []v1beta1.FixedIP{}
	for _, ip := range *in {
		fipList = append(fipList, v1beta1.FixedIP{
			Subnet: &v1beta1.SubnetFilter{
				ID: ip.SubnetID,
			},
...
// Convert_v1beta1_PortOpts_To_v1alpha4_PortOpts is not an autogenerated conversion function.
func Convert_v1beta1_FixedIPs_To_v1alpha4_FixedIPs(in *[]v1beta1.FixedIP, out *[]FixedIP, s conversion.Scope) error {
	return autoConvert_v1beta1_FixedIPs_To_v1alpha4_FixedIPs(in, out, s)
}

func autoConvert_v1beta1_FixedIPs_To_v1alpha4_FixedIPs(in *[]v1beta1.FixedIP, out *[]FixedIP, s conversion.Scope) error {
	fipList := []FixedIP{}
	for _, ip := range *in {
		...
		if ip.Subnet != nil {
			if ip.Subnet.ID != "" {
				val.SubnetID = ip.Subnet.ID
			} else {
				return errors.InvalidMachineConfiguration("cannot convert v1beta1 fixedIP to v1alpha4 fixedIP when subnet.ID is not set")
			}
		}
		fipList = append(fipList, val)
	}
