...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Monitor)(nil), (*v1alpha6.Monitor)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_Monitor_To_v1alpha6_Monitor(a.(*Monitor), b.(*v1alpha6.Monitor), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha6.Monitor)(nil), (*Monitor)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha6_Monitor_To_v1alpha4_Monitor(a.(*v1alpha6.Monitor), b.(*Monitor), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha4_Monitor_To_v1alpha6_Monitor(in *Monitor, out *v1alpha6.Monitor, s conversion.Scope) error {
	out.Delay = in.Delay
...
// Convert_v1alpha4_Monitor_To_v1alpha6_Monitor is an autogenerated conversion function.
func Convert_v1alpha4_Monitor_To_v1alpha6_Monitor(in *Monitor, out *v1alpha6.Monitor, s conversion.Scope) error {
	return autoConvert_v1alpha4_Monitor_To_v1alpha6_Monitor(in, out, s)
}

func autoConvert_v1alpha6_Monitor_To_v1alpha4_Monitor(in *v1alpha6.Monitor, out *Monitor, s conversion.Scope) error {
	out.Delay = in.Delay
	out.MaxRetries = in.MaxRetries
	out.Timeout = in.Timeout
	return nil
...
// Convert_v1alpha6_Monitor_To_v1alpha4_Monitor is an autogenerated conversion function.
func Convert_v1alpha6_Monitor_To_v1alpha4_Monitor(in *v1alpha6.Monitor, out *Monitor, s conversion.Scope) error {
	return autoConvert_v1alpha6_Monitor_To_v1alpha4_Monitor(in, out, s)
}
