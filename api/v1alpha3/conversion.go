...
func Convert_v1alpha3_OpenStackClusterSpec_To_v1alpha5_OpenStackClusterSpec(in *OpenStackClusterSpec, out *v1alpha5.OpenStackClusterSpec, s conversion.Scope) error {
...
func Convert_v1alpha5_OpenStackClusterSpec_To_v1alpha3_OpenStackClusterSpec(in *v1alpha5.OpenStackClusterSpec, out *OpenStackClusterSpec, s conversion.Scope) error {
...
func Convert_v1alpha3_OpenStackMachineSpec_To_v1alpha5_OpenStackMachineSpec(in *OpenStackMachineSpec, out *v1alpha5.OpenStackMachineSpec, s conversion.Scope) error {
	if in.CloudsSecret != nil {
		out.IdentityRef = &v1alpha5.OpenStackIdentityReference{
			Name: in.CloudsSecret.Name,
			Kind: "Secret",
		}
	}
	return autoConvert_v1alpha3_OpenStackMachineSpec_To_v1alpha5_OpenStackMachineSpec(in, out, s)
}
...
func Convert_v1alpha5_Network_To_v1alpha3_Network(in *v1alpha5.Network, out *Network, s conversion.Scope) error {
...
func Convert_v1alpha5_OpenStackMachineSpec_To_v1alpha3_OpenStackMachineSpec(in *v1alpha5.OpenStackMachineSpec, out *OpenStackMachineSpec, s conversion.Scope) error {
	return autoConvert_v1alpha5_OpenStackMachineSpec_To_v1alpha3_OpenStackMachineSpec(in, out, s)
}
...
func Convert_v1alpha5_OpenStackClusterStatus_To_v1alpha3_OpenStackClusterStatus(in *v1alpha5.OpenStackClusterStatus, out *OpenStackClusterStatus, s conversion.Scope) error {
	return autoConvert_v1alpha5_OpenStackClusterStatus_To_v1alpha3_OpenStackClusterStatus(in, out, s)
}

func Convert_Slice_v1alpha5_Network_To_Slice_v1alpha3_Network(in *[]v1alpha5.Network, out *[]Network, s conversion.Scope) error {
	for i := range *in {
		inNet := &(*in)[i]
		outNet := new(Network)
...
func Convert_Slice_v1alpha3_Network_To_Slice_v1alpha5_Network(in *[]Network, out *[]v1alpha5.Network, s conversion.Scope) error {
	for i := range *in {
		inNet := &(*in)[i]
		outNet := new(v1alpha5.Network)
