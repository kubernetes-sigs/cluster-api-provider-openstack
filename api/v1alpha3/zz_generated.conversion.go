...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Filter)(nil), (*v1beta1.NetworkFilter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_Filter_To_v1beta1_Filter(a.(*Filter), b.(*v1beta1.NetworkFilter), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.NetworkFilter)(nil), (*Filter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_Filter_To_v1alpha3_Filter(a.(*v1beta1.NetworkFilter), b.(*Filter), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_Filter_To_v1beta1_Filter(in *Filter, out *v1beta1.NetworkFilter, s conversion.Scope) error {
	out.Name = in.Name
...
func Convert_v1alpha3_Filter_To_v1beta1_Filter(in *Filter, out *v1beta1.NetworkFilter, s conversion.Scope) error {
	return autoConvert_v1alpha3_Filter_To_v1beta1_Filter(in, out, s)
}

func autoConvert_v1beta1_Filter_To_v1alpha3_Filter(in *v1beta1.NetworkFilter, out *Filter, s conversion.Scope) error {
	out.Name = in.Name
	out.Description = in.Description
	out.ProjectID = in.ProjectID
	out.ID = in.ID
...
func Convert_v1beta1_Filter_To_v1alpha3_Filter(in *v1beta1.NetworkFilter, out *Filter, s conversion.Scope) error {
